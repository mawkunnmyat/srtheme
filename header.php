...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'srtheme' ); ?></a>

        <!-- Added by Poe Ei Phyu Start Here -->
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="announcement-bar__list">
                            <li>
                                ...
                                <a href="tel: 09965088114" class="text-decoration-none">+959 96 50 88 114</a>
                            </li>

                            <li>
                                <i class="bi bi-envelope rounded-circle"></i>
                                <a href="mailto:office@tworksystem.com"
                                    class="text-decoration-none">office@tworksystem.com</a>
                            </li>
                        </ul>
        ...
        <header id="masthead" class="site-header">
            ...
            <!-- Added Nav Tag by Poe Ei Phyu Start Here -->
            ...
            <!-- Added Nav Tag by Poe Ei Phyu End Here -->
        </header><!-- #masthead -->